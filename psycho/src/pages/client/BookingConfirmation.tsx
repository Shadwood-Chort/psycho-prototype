...
export function BookingConfirmation() {
  ...
  if (!appt || !psychologist) {
    return (
      <div className="flex min-h-full flex-col items-center justify-center px-6 text-center">
        <p className="text-[14px] text-sage-500">Запись не найдена.</p>
  ...
  return (
    <div className="flex min-h-full flex-col px-6 pb-6 pt-14 text-center">
      ...
      <h1 className="text-xl font-semibold text-sage-900">Запись подтверждена!</h1>
      ...
      <Card className="mt-6 text-left">
        ...
        <div className="mt-3 flex justify-between text-[12px] text-sage-600">
          <span>{appt.format === "online" ? "Формат: Онлайн" : "Формат: Офлайн"}</span>
